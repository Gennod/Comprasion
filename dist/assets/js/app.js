...
/***/ "./src/assets/js/components/comprasion.js":
/*!************************************************!*\
  !*** ./src/assets/js/components/comprasion.js ***!
  \************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _hystmodal_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./hystmodal.min */ "./src/assets/js/components/hystmodal.min.js");
/* harmony import */ var _hystmodal_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_hystmodal_min__WEBPACK_IMPORTED_MODULE_0__);

var myModal = new HystModal({
  linkAttributeName: "data-hystmodal"
});
var myModalGood = new HystModal({
  linkAttributeName: "data-hystmodal"
});
var goodsWrapper = document.querySelector(".comprasion__goods"),
    ...
    modalTitle = document.querySelector(".hystmodal__title"); // goodsWrapper.addEventListener("wheel", function (event) {
//     let modifier;
...
var k = 0;
var amount = 0;
goodFix.forEach(function (fix, idx) {
  goods.push({
    fix: fix,
    idx: idx,
    isFixed: "false"
  });
  fix.addEventListener("click", function (evt) {
    var good = evt.currentTarget.parentNode.parentNode,
        countGoods = 0,
        widthToTranslate = 0,
        fixedGoodsWidth = 0,
    ...
    if (goods[idx].isFixed === "true") {
      ...
      // }
      // unFixedGoodsAmount -= 1;
      goods[idx].fix.parentNode.parentNode.style.transform = "translateX(".concat(0, ")");

      for (var i = 0; i < goods.length; i++) {
        if (goods[i].idx < goods[idx].idx && goods[i].isFixed === "false") {
          goods[i].fix.parentNode.parentNode.style.transform += "translateX(-".concat(good.offsetWidth, "px)");
        }
      }

      good.classList.remove("comprasion__good-fix--active");
      goods[idx].isFixed = "false"; // console.log(fixedGoodsAmount);
      ...
      for (var _i = 0; _i < goods.length; _i++) {
        if (goods[_i].idx < goods[idx].idx) {
          unFixedGoodsAmount += 1;
        }
      }

      for (var _i2 = 0; _i2 < goods.length; _i2++) {
        if (goods[_i2].isFixed === "true") {
          fixedGoodsAmount += 1;
        }
      }

      good.style.transform = "translateX(-".concat(good.offsetWidth * unFixedGoodsAmount, "px)");

      for (var _i3 = 0; _i3 < goods.length; _i3++) {
        if (goods[_i3].idx < goods[idx].idx && goods[_i3].isFixed === "false") {
          goods[_i3].fix.parentNode.parentNode.style.transform += "translateX(".concat(good.offsetWidth, "px)");
        }
      }

      for (var _i4 = 0; _i4 < goods.length; _i4++) {
        if (goods[_i4].isFixed === "true") {
          goods[_i4].fix.parentNode.parentNode.style.transform += "translateX(".concat(good.offsetWidth, "px)");
        }
      }
      ...
      for (var _i5 = 0; _i5 < goods.length; _i5++) {
        if (goods[_i5].idx <= goods[idx].idx) {
          amount += 1;
        }
      }
      ...
      for (var _i6 = 0; _i6 < goods.length; _i6++) {
        if (goods[_i6].isFixed === "true" && goods[idx].idx !== goods[_i6].idx) {
          goods[_i6].fix.parentNode.parentNode.classList.remove("comprasion__good-fix--last");
        }
      }
    }
  });
});
goodDelete.forEach(function (btn) {
  btn.addEventListener("click", function (evt) {
    var good = evt.currentTarget.parentNode.parentNode.parentNode;
    document.querySelector(".hystmodal__btn-good--delete").addEventListener("click", function () {
      good.remove();
      myModalGood.close();
...
goodCancel.addEventListener("click", function () {
  myModalGood.close();
});
modalDelete.addEventListener("click", function () {
  goodFix.forEach(function (good) {
    return good.parentNode.parentNode.remove();
  });
  setTimeout(function () {
    window.location.href = "/no-goods.html";
  }, 100);
...
/***/ "./src/assets/js/components/hystmodal.min.js":
/*!***************************************************!*\
  !*** ./src/assets/js/components/hystmodal.min.js ***!
  \***************************************************/
/***/ (function() {
...
/* harmony import */ var _components_comprasion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/comprasion */ "./src/assets/js/components/comprasion.js");
